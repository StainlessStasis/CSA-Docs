...
| statDisplayModes          | Defines which stats are shown in the alert, and how. The options are: `"MAIN_MESSAGE"`, `"HOVER"`, `BOTH`, and `"DISABLED"`. The following will not display without the server broadcasting them to clients: `ivs`, `nature`, and `ability`. EV yields (`evs`) may be inaccurate.                                                                                                          | 
...
| sendWebhook               | Sends a Discord webhook for the Pokemon.                                                                                                                                                                                                                                                                                                                                                   |                                                                                                                                                                                                                                                                                                                                                
:::warning Important
